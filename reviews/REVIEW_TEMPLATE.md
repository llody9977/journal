...
| --- | --- | --- |
| Factual and technical correctness | No |  |
| Evidence, authority, version, date, jurisdiction, and applicability | No |  |
| Adversarial wording, assumptions, attacker state, and counterexamples | No |  |
| Terminology, taxonomy, and conceptual boundaries | No |  |
| Cross-format consistency | No |  |
...
- [ ] Every in-scope artifact was inventoried and read in full.
