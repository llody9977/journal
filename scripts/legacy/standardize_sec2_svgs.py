...
raise SystemExit(
    "standardize_sec2_svgs.py is retired. The reviewed SVG files in assets/img "
...
NEW_SVGS['signature-pipeline.svg'] = """<svg viewBox="0 0 1200 410" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif">
  ...
  <text x="480" y="232" font-size="9.5" fill="#475569">• ECDSA nonce: fresh random or RFC 6979 deterministic</text>
...
NEW_SVGS['password-hash-comparison.svg'] = """<svg viewBox="0 0 1200 410" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif">
  ...
  <text x="50" y="102" font-size="11" font-style="italic" fill="#64748b">Y-axis: illustrative attacker throughput tier (qualitative) — higher bar means faster for an attacker, not more resistant</text>
