...
<div class="diagram-frame diagram-frame-openable">
  <a class="diagram-open-link" href="{{ '/assets/img/key-size-comparison.svg' | relative_url }}" target="_blank" rel="noopener" aria-label="Open the key size comparison diagram at full size">
    <img src="{{ '/assets/img/key-size-comparison.svg' | relative_url }}" alt="Comparison chart comparing RSA and ECC key sizes in bits across 112-bit, 128-bit, 192-bit, and 256-bit security strengths. RSA key sizes grow sub-exponentially while ECC key sizes scale compactly.">
  </a>
