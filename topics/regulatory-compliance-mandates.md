...
<div class="security-layer security-layer-direct">
  ...
  <div>
    ...
    <ul>
      ...
      <li><strong>Commercial Attestation</strong>: ISO 27001, PCI-DSS, and SOC 2 are contractual/industry requirements, not statutes—the standard itself carries no government penalty, but non-compliance can still trigger contractual consequences (breach, lost certification, lost business relationships) once the standard is incorporated into an agreement, and in some cases a law incorporates the standard directly (e.g., Nevada's NRS 603A.215 for PCI-DSS), making it a statutory requirement for the businesses it covers.</li>
