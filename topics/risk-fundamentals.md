...
| **Legacy TLS 1.0 Support on Public Web Endpoint** | **CVSS ~5.3** (Medium, hypothetical) | Internet-exposed public endpoint storing financial PII. | Likely violates **[PCI DSS 4.0.1](https://www.pcisecuritystandards.org/wp-content/uploads/2024/10/SAQs_for_PCI_DSS_v4.0.1_Bulletin.pdf)** (PCI DSS 4.0 was retired at the end of 2024) requirements around strong cryptography for cardholder data, making the regulatory exposure plausibly higher than the Medium CVSS score alone suggests. |
