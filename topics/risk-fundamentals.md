...
<div class="callout">
  ...
  <p>Risk exists when a plausible circumstance or threat event can cause consequential harm; a vulnerability is one possible path, not a universal prerequisite, and neither a vulnerability nor a high severity score establishes risk alone. Assess likelihood and impact in context, account for existing controls, and record an authorized response.</p>
</div>
