...
<div class="security-layer security-layer-direct">
  ...
  <div>
    ...
    <ul>
      <li><strong>Control Categories</strong>: Preventive (intercepts known threats before execution), Detective (alerts after the fact), Corrective (restores state—only as clean as its source), Compensating (alternate protection when the primary control is infeasible).</li>
