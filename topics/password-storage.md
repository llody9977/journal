...
<p class="lede">This is my reminder that password hashing has the opposite performance goal from ordinary hashing. A fast SHA-256 implementation is good engineering for files and signatures, but a bad password verifier because it lets an attacker test guesses cheaply after a database leak.</p>
